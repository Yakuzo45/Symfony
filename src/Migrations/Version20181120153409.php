 ...
 */
final class Version20181120153409 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tag ADD categories_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE tag ADD CONSTRAINT FK_389B783A21214B7 FOREIGN KEY (categories_id) REFERENCES category (id)');
        $this->addSql('CREATE INDEX IDX_389B783A21214B7 ON tag (categories_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tag DROP FOREIGN KEY FK_389B783A21214B7');
        $this->addSql('DROP INDEX IDX_389B783A21214B7 ON tag');
        $this->addSql('ALTER TABLE tag DROP categories_id');
    }
}
